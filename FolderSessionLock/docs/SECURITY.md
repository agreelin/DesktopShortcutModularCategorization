...
- 当前 frozen execution commit/tree 为 `3170d89cfd6066ba494170826cd43626d83c6789` / `6bee7c4db4c9adde0612aa7c67467a331d20263e`；WAL 为 4 records。只读 DPAPI/HMAC 认证确认 latest `anchor-1.json` 为 generation 11，绑定当前 WAL length 22920、SHA-256 `C299D1FE85E542603BABF5DB4B38796343CD8158817853F9E1D53EEFD15CEF69`；previous `anchor-0.json` 为 generation 10，绑定先前 WAL length 22182、SHA-256 `C535582A1B2545681CAE5A681BC6B7010D5D21E78F7DAE303EBED279EC43B7FF`。这是 current pre-recovery 11/10；generation 14/13 仅是未来 recovery 成功后的 postcondition。recovery 为 3 directories/8 files，Release 为 22 files。Program Files 安装目录为空，ProgramData product root 不存在。
